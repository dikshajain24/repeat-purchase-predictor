...
<!-- Main Highlight -->
<p align="center">
  <img src="https://github.com/user-attachments/assets/d6325936-af20-4a08-8b9a-6a4d4e1a10b4" 
       alt="Main dashboard overview of Repeat Purchase Prediction App (clean version)" width="850"/>
</p>
<p align="center"><em>📊 Clean homepage view of the Repeat Purchase Prediction App</em></p>
...
<p align="center"><em>📈 Customer purchase trends (left) and filtered repeat purchase dataset (right)</em></p>
...
<p align="center"><em>🛍️ Product-level analytics (left) and purchase frequency comparison (right)</em></p>
...
<p align="center"><em>✅ Final prediction results showing customer likelihood of repeat purchase, with options to download results and update the template</em></p>
